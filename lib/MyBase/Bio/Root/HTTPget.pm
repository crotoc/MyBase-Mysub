...
MyBase::Bio::Root::HTTPget - module for fallback HTTP get operations when 
LWP:: is unavailable

=head1 SYNOPSIS

 use MyBase::Bio::Root::HTTPget;
 my $web = MyBase::Bio::Root::HTTPget->new();
...
package MyBase::Bio::Root::HTTPget;
...
sub get {
    my $self;
    if($_[0] && (ref($_[0]) or $_[0] =~ /^MyBase::Bio::/)) {
	$self = shift;
    }
