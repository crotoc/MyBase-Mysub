#
# BioPerl module for MyBase::Bio::Root::RootI
#
...
MyBase::Bio::Root::RootI - Abstract interface to root object code
...
L<MyBase::Bio::Exception::NotImplemented> exception will result.
...
throw a L<MyBase::Bio::Exception::NotImplemented>.
...
sub new {
  ...
  unless ( $ENV{'BIOPERLDEBUG'} ) {
      carp("Use of new in MyBase::Bio::Root::RootI is deprecated.  Please use MyBase::Bio::Root::Root instead");
  }
  eval "require MyBase::Bio::Root::Root";
  return MyBase::Bio::Root::Root->new(@args);
}
...
sub deprecated{
    ...
    return if ($warn_version && $MyBase::Bio::Root::Version::VERSION < $warn_version);
    ...
    if ($version) {
        ...
        if ($MyBase::Bio::Root::Version::VERSION >= $version) {
            $self->throw($msg)
        } 
    }
...
=head2 _rearrange
 ...
 Source    : This function was taken from CGI.pm, written by Dr. Lincoln
           : Stein, and adapted for use in MyBase::Bio::Seq by Richard Resnick and
           : then adapted for use in MyBase::Bio::Root::Object.pm by Steve Chervitz,
           : then migrated into MyBase::Bio::Root::RootI.pm by Ewan Birney.
 Comments  :
...
=head2 _set_from_args
 ...
 Comments  :
           ...
           : MyBase::Bio::Tools::Run::WrapperBase's _setparams() method and code along
           : the lines of:
...
sub _cleanup_methods {
  ...
  unless ( $ENV{'BIOPERLDEBUG'} || $self->verbose  > 0 ) {
      carp("Use of MyBase::Bio::Root::RootI is deprecated.  Please use MyBase::Bio::Root::Root instead");
  }
  return;
}
...
=head2 throw_not_implemented
 ...
 Purpose : Throws a MyBase::Bio::Root::NotImplemented exception.
 ...
 Returns : n/a
 Args    : n/a
 Throws  : A MyBase::Bio::Root::NotImplemented exception.
...
sub throw_not_implemented {
    ...
    # MyBase::Bio::Root::Root::throw() knows how to check for Error.pm and will
    # throw an Error-derived object of the specified class (MyBase::Bio::Root::NotImplemented),
    # which is defined in MyBase::Bio::Root::Exception.
