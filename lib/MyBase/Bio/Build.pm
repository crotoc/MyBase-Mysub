#
# BioPerl module for MyBase::Bio::Root::Build
#
...
MyBase::Bio::Root::Build - A common Module::Build subclass base for BioPerl distributions
...
#            }
#
#            # MyBase::Bio::Root::Version number comes out as triplet number like 1.5.2;
#            # convert to our own version
#            if ($modname eq 'MyBase::Bio::Root::Version') {
